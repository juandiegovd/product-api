...
describe('ReportService', () => {
  ...
  it('should return correct active percentage', async () => {
    ...
    contentRepository.count = jest.fn().mockReturnValue(10);
    contentRepository.createQueryBuilder = jest.fn().mockReturnValue(mockQueryBuilder);
    const response = await service.getActiveProductsPercentage(new Date('2025-01-01'), new Date('2026-01-01'));
    expect(response).toEqual(40)
  });
